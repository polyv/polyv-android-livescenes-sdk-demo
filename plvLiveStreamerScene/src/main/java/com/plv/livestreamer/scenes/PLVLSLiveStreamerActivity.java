package com.plv.livestreamer.scenes;
...
import com.plv.livestreamer.modules.chatroom.IPLVLSChatroomLayout;
import com.plv.livestreamer.modules.document.IPLVLSDocumentLayout;
import com.plv.livestreamer.modules.document.PLVLSDocumentLayout;
import com.plv.livestreamer.modules.document.widget.PLVLSDocumentControllerExpandMenu;
import com.plv.livestreamer.modules.statusbar.IPLVLSStatusBarLayout;
import com.plv.livestreamer.modules.streamer.IPLVLSStreamerLayout;
...
public class PLVLSLiveStreamerActivity extends PLVBaseActivity {
    ...
    private void initView() {
        ...
        if(PLVStreamerInnerDataTransfer.getInstance().isOnlyAudio()){
    ...
    private void observeStatusBarLayout() {
        ...
        plvlsStatusBarLy.setOnViewActionListener(new IPLVLSStatusBarLayout.OnViewActionListener() {
            ...
            public void onGrantSpeakerPermission(int position, String userId, final boolean isGrant) {
                plvlsStreamerLy.getStreamerPresenter().setUserPermissionSpeaker(userId, isGrant, new IPLVLinkMicEventSender.PLVMainCallAck() {
                    @Override
