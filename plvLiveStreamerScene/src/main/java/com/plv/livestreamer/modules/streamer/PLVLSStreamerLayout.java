package com.plv.livestreamer.modules.streamer;
...
import com.plv.livecommon.module.modules.streamer.presenter.PLVStreamerPresenter;
...
import com.plv.livestreamer.modules.streamer.adapter.PLVLSStreamerAdapter;
...
public class PLVLSStreamerLayout extends FrameLayout implements IPLVLSStreamerLayout {
    ...
    private void initView() {
        ...
        streamerAdapter.setIsOnlyAudio(PLVStreamerInnerDataTransfer.getInstance().isOnlyAudio());

        //启动前台服务，防止在后台被杀
        PLVForegroundService.startForegroundService(PLVLSLiveStreamerActivity.class, "手机开播", R.drawable.plvls_ic_launcher);
        //防止自动息屏、锁屏
    ...
    private PLVAbsStreamerView streamerView = new PLVAbsStreamerView() {
        ...
        public void onStreamerEngineCreatedSuccess(String linkMicUid, List<PLVLinkMicItemDataBean> linkMicList) {
            ...
            streamerPresenter.setMixLayoutType(PLVStreamerConfig.MixStream.MIX_LAYOUT_TYPE_SPEAKER);
