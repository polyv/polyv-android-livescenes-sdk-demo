package com.plv.livestreamer.modules.document;
...
import com.plv.livescenes.document.PLVDocumentWebView;
import com.plv.livescenes.document.model.PLVPPTPaintStatus;
import com.plv.livestreamer.R;
import com.plv.livestreamer.modules.document.widget.PLVLSDocumentControllerExpandMenu;
import com.plv.livestreamer.modules.document.widget.PLVLSDocumentControllerLayout;
import com.plv.livestreamer.modules.document.widget.PLVLSDocumentInputWidget;
...
public class PLVLSDocumentLayout extends FrameLayout implements IPLVLSDocumentLayout {
    ...
    private PLVDocumentWebView plvlsDocumentWebView;
    ...
    private void findView() {
        plvlsDocumentWebView = (PLVDocumentWebView) rootView.findViewById(R.id.plvls_document_web_view);
    ...
    private void initPresenter() {
        ...
        documentPresenter.init((LifecycleOwner) getContext(), liveRoomDataManager, new PLVDocumentWebProcessor(plvlsDocumentWebView));
    }
