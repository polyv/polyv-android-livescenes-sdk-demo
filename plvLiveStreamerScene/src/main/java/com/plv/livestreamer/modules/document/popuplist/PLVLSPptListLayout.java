...
public class PLVLSPptListLayout extends FrameLayout {
    ...
    // PPT文档上传监听接口实现
    private OnPLVDocumentUploadListener documentUploadListener;
    ...
    private void initDocumentUploadListener() {
        documentUploadListener = new OnPLVDocumentUploadListener() {
            @Override
     ...
     * @param jsModel
     */
    private void processPptPageList(PLVPPTJsModel jsModel) {
     ...
     * 刷新ppt状态
     */
    private void refreshPptPageStatus(PLVPPTJsModel jsModel){
        List<PLVLSPptVO> pptVOList = new ArrayList<>();
        for (PLVPPTDetail pptDetail : jsModel.getPPTImages()) {
