...
[![GitHub release](https://img.shields.io/badge/release-v1.41.0-blue.svg)](https://github.com/polyv/polyv-android-livescenes-sdk-demo/releases/tag/v1.41.0)
...
|-------------|------------|-------------------------------------------------------------------------------------------|---------|--------|--------|-------------|---------------|--------|
| 1.41.0      | 1.41.0     | [v1.41.0 API](http://repo.polyv.net/android/livescenes/javadoc/1.41.0/index.html)         | ✅       |  ✅       |        |   ✅           |     ✅           |        |
| 1.40.0      | 1.40.0     | [v1.40.0 API](http://repo.polyv.net/android/livescenes/javadoc/1.40.0/index.html)         | ✅       |        |        |             |               |        |
| 1.36.0      | 1.36.0     | [v1.36.0 API](http://repo.polyv.net/android/livescenes/javadoc/1.36.0/index.html)         | ✅       |   ✅    |  ✅     |  ✅          | ✅             |        |
| 1.35.0      | 1.35.0     | [v1.35.0 API](http://repo.polyv.net/android/livescenes/javadoc/1.35.0/index.html)         | ✅       |   ✅    |  ✅     |             |               |        |
| 1.34.2      | 1.34.2     | [v1.34.2 API](http://repo.polyv.net/android/livescenes/javadoc/1.34.2/index.html)         | ✅       |   ✅    |  ✅     |  ✅          |  ✅            |        |
| 1.34.1      | 1.34.1     | [v1.34.1 API](http://repo.polyv.net/android/livescenes/javadoc/1.34.1/index.html)         | ✅       |   ✅    |  ✅     |             |               |        |
