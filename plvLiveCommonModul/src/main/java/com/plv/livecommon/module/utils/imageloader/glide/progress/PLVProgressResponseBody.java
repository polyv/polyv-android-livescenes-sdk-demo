package com.plv.livecommon.module.utils.imageloader.glide.progress;
...
public class PLVProgressResponseBody extends ResponseBody {
    ...
    PLVProgressResponseBody(String url, InternalProgressListener internalProgressListener,
