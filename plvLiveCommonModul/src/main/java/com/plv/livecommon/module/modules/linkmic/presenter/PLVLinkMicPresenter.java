package com.plv.livecommon.module.modules.linkmic.presenter;
...
import com.plv.livecommon.module.modules.linkmic.contract.IPLVLinkMicContract;
import com.plv.livecommon.module.modules.linkmic.model.PLVLinkMicDataMapper;
import com.plv.livecommon.module.modules.linkmic.model.PLVLinkMicItemDataBean;
import com.plv.livecommon.module.modules.linkmic.model.PLVLinkMicListShowMode;
import com.plv.livecommon.module.modules.linkmic.model.PLVLinkMicListShowModeGetter;
import com.plv.livecommon.module.modules.linkmic.model.PLVLinkMicMsgHandler;
import com.plv.livecommon.module.modules.linkmic.model.PLVLinkMicMuteCacheList;
...
public class PLVLinkMicPresenter implements IPLVLinkMicContract.IPLVLinkMicPresenter {
    ...
    /**** Listener ****/
    //rtc事件监听器
    private PLVLinkMicEventListener eventListener = new PLVLinkMicEventListenerImpl();
    //socket事件监听器
    private PLVLinkMicSocketEventListener socketEventListener = new PLVLinkMicSocketEventListener();
    //socket监听器
...
// </editor-fold>
    ...
    private class PLVLinkMicEventListenerImpl extends PLVLinkMicEventListener {
        @Override
        public void onJoinChannelSuccess(String uid) {
            PLVCommonLog.d(TAG, "PLVLinkMicEventListenerImpl.onJoinChannelSuccess, uid=" + uid);
            stopJoinTimeoutCount();
            //连麦限制，全体静音响应
            loadLinkMicConnectMode(avConnectMode);
        }
        ...
        public void onLeaveChannel() {
            PLVCommonLog.d(TAG, "PLVLinkMicEventListenerImpl.onLeaveChannel");
            leaveChannel();
        }

        @Override
        public void onUserJoined(String uid) {
            PLVCommonLog.d(TAG, "PLVLinkMicEventListenerImpl.onUserJoined, uid=" + uid);
            dispose(getLinkMicListDelay);
        ...
        public void onUserOffline(String uid) {
            PLVCommonLog.d(TAG, "PLVLinkMicEventListenerImpl.onUserOffline, uid=" + uid);
        ...
        public void onUserMuteAudio(String uid, boolean mute) {
            PLVCommonLog.d(TAG, "PLVLinkMicEventListenerImpl.onUserMuteAudio,uid=" + uid + " mute=" + mute);
            for (int i = 0; i < linkMicList.size(); i++) {
                PLVLinkMicItemDataBean plvLinkMicItemDataBean = linkMicList.get(i);
        ...
        public void onUserMuteVideo(String uid, boolean mute) {
            PLVCommonLog.d(TAG, "PLVLinkMicEventListenerImpl.onUserMuteVideo uid=" + uid);
            for (int i = 0; i < linkMicList.size(); i++) {
                PLVLinkMicItemDataBean plvLinkMicItemDataBean = linkMicList.get(i);
                if (uid.equals(plvLinkMicItemDataBean.getLinkMicId())) {
                    plvLinkMicItemDataBean.setMuteVideo(mute);
...
// </editor-fold>
    ...
    private class PLVLinkMicSocketEventListener implements PLVLinkMicMsgHandler.OnLinkMicDataListener {
        @Override
        public void onTeacherReceiveJoinRequest() {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onTeacherReceiveJoinRequest");
        }

        @Override
        public void onTeacherAllowMeToJoin() {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onTeacherAllowMeToJoin");
            handleTeacherAllowJoin(isAudioLinkMic);
        }

        @Override
        public void onTeacherHangupMe() {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onTeacherHangupMe");
            if (rtcInvokeStrategy != null) {
                rtcInvokeStrategy.setLeaveLinkMic();
            }
        }
        ...
        public void onTeacherOpenLinkMic() {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onTeacherOpenLinkMic");
        ...
        public void onTeacherCloseLinkMic() {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onTeacherCloseLinkMic");
        ...
        public void onTeacherMuteMedia(boolean isMute, boolean isAudio) {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onTeacherMuteMedia");
        ...
        public void onUserJoinSuccess(PLVLinkMicItemDataBean dataBean) {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onUserJoinSuccess");
            if (rtcInvokeStrategy == null || !rtcInvokeStrategy.isJoinChannel()) {
                return;
            }
        ...
        public void onTeacherSendCup(String linkMicId, int cupNum) {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onTeacherSendCup");
            if (rtcInvokeStrategy == null || !rtcInvokeStrategy.isJoinChannel()) {
                return;
            }
            for (PLVLinkMicItemDataBean itemDataBean : linkMicList) {
        ...
        public void onFinishClass() {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onFinishClass");
            handleTeacherCloseLinkMic();
            if (rtcInvokeStrategy != null) {
                rtcInvokeStrategy.setLiveEnd();
            }
        ...
        public void onLinkMicConnectMode(String avConnectMode) {
            PLVCommonLog.d(TAG, "PLVLinkMicSocketEventListener.onLinkMicConnectMode " + avConnectMode);
