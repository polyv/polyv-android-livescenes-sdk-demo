package com.plv.livecommon.module.modules.interact;
...
import com.plv.livecommon.module.modules.interact.app.PLVInteractAnswer;
import com.plv.livecommon.module.modules.interact.app.PLVInteractBulletin;
import com.plv.livecommon.module.modules.interact.app.PLVInteractCommonControl;
import com.plv.livecommon.module.modules.interact.app.PLVInteractLottery;
import com.plv.livecommon.module.modules.interact.app.PLVInteractQuestionnaire;
import com.plv.livecommon.module.modules.interact.app.PLVInteractSignIn;
...
import com.plv.livescenes.feature.interact.PLVInteractWebView;
...
// </editor-fold>
    ...
    private void handleKeyboardOrientation() {
        ...
        if (context instanceof Activity) {
            ...
            post(new Runnable() {
                @Override
                public void run() {
                    new PLVAnswerKeyboardHelper(activity);
                }
            });
        }
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="内部类 - PLVAnswerKeyboardHelper">
     ...
     * 需要用到的互动应用：调查问卷，抽奖
     */
    private class PLVAnswerKeyboardHelper {
        ...
        private PLVAnswerKeyboardHelper(Activity activity) {
