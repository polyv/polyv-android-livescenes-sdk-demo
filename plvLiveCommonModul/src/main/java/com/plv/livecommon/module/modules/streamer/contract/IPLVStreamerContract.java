package com.plv.livecommon.module.modules.streamer.contract;
...
public interface IPLVStreamerContract {
    ...
    interface IStreamerPresenter {
         ...
         * @param bitrate 码率
         */
        void setBitrate(@PLVStreamerConfig.BitrateType int bitrate);
         ...
         */
        void setMixLayoutType(@PLVStreamerConfig.MixStreamType int mixLayoutType);
