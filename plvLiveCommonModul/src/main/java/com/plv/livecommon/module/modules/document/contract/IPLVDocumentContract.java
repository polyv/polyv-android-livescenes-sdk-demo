package com.plv.livecommon.module.modules.document.contract;
...
public interface IPLVDocumentContract {
    ...
    interface View {
         ...
         */
        void onPptCoverList(@Nullable PLVPPTInfo pptInfo);
         ...
         */
        void onPptPageList(@Nullable PLVPPTJsModel plvspptJsModel);
         ...
         */
        void onPptStatusChange(PLVPPTStatus pptStatus);
         ...
         */
        void onPptPaintStatus(@Nullable PLVPPTPaintStatus pptPaintStatus);
    ...
    interface Presenter {
         ...
         */
        void init(LifecycleOwner lifecycleOwner, IPLVLiveRoomDataManager liveRoomDataManager, PLVDocumentWebProcessor documentWebProcessor);
         ...
         * 请求获取所有PPT文档列表
         *
         * @see View#onPptCoverList(PLVPPTInfo)
         */
         ...
         *
         * @param autoId PPT ID
         * @see View#onPptPageList(PLVPPTJsModel)
         */
        ...
        void uploadFile(Context context,
                        File uploadFile,
                        @PLVDocumentUploadConstant.PPTConvertType.PPTConvertTypeAnno String convertType,
                        OnPLVDocumentUploadListener listener);
         ...
         * @param listener 上传回调
         */
        void restartUploadFromCache(Context context, String fileId, OnPLVDocumentUploadListener listener);
