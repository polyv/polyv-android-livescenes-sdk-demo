package com.plv.livecommon.module.modules.player.live.presenter;
...
import com.plv.business.model.video.PLVDefinitionVO;
import com.plv.business.model.video.PLVLiveChannelVO;
import com.plv.business.model.video.PLVLiveLinesVO;
...
import com.plv.livecommon.module.modules.watermark.IPLVWatermarkView;
import com.plv.livecommon.module.modules.watermark.PLVWatermarkCommonController;
import com.plv.livecommon.module.modules.watermark.PLVWatermarkTextVO;
import com.plv.livecommon.module.modules.marquee.IPLVMarqueeView;
import com.plv.livecommon.module.modules.marquee.PLVMarqueeCommonController;
import com.plv.livecommon.module.modules.marquee.model.PLVMarqueeModel;
import com.plv.livecommon.module.modules.player.live.contract.IPLVLivePlayerContract;
import com.plv.livecommon.module.modules.player.live.presenter.data.PLVLivePlayerData;
...
public class PLVLivePlayerPresenter implements IPLVLivePlayerContract.ILivePlayerPresenter {
    ...
    private PLVLiveVideoView videoView;
    ...
    @Nullable
    @Override
    public List<PLVDefinitionVO> getBitrateVO() {
        List<PLVDefinitionVO> definitionVOS = null;
        if (videoView != null) {
            PLVLiveChannelVO channelVO = videoView.getModleVO();
            if (channelVO != null) {
                List<PLVLiveLinesVO> liveLines = channelVO.getLines();//线路数量
                if (liveLines != null) {
                    PLVLiveLinesVO linesVO = liveLines.get(getLinesPos());//当前线路信息
                    if (linesVO != null && linesVO.getMultirateModel() != null) {//存在码率信息
                        if (channelVO.isMutilrateEnable()) {//多码率可用
                            ...
                            definitionVOS.add(new PLVDefinitionVO(linesVO.getMultirateModel().getDefaultDefinition()
    ...
    public int getMediaPlayMode() {
        ...
        return PLVMediaPlayMode.MODE_VIDEO;
    }
    ...
    @Override
    public PLVLiveChannelVO getChannelVO() {
    ...
    private void initSubVideoViewListener() {
        if (subVideoView != null) {
            subVideoView.setOnVideoPlayListener(new IPLVVideoViewListenerEvent.OnVideoPlayListener() {
                @Override
            ...
            onSubGestureClickListener = new IPLVVideoViewListenerEvent.OnGestureClickListener() {
                @Override
            ...
            subVideoView.setOnSubVideoViewLoadImage(new IPLVAuxiliaryVideoViewListenerEvent.IPLVOnSubVideoViewLoadImage() {
                @Override
            ...
            subVideoView.setOnSubVideoViewCountdownListener(new IPLVAuxiliaryVideoViewListenerEvent.IPLVOnSubVideoViewCountdownListener() {
                @Override
    ...
    private void initVideoViewListener() {
        if (videoView != null) {
            videoView.setOnErrorListener(new IPLVVideoViewListenerEvent.OnErrorListener() {
                @Override
                public void onError(int what, int extra) {/**/}

                @Override
                public void onError(PLVPlayError error) {
                    setDefaultViewStatus();
                    String tips;
                    switch (error.playStage) {
                        case PLVPlayError.PLAY_STAGE_HEADAD:
                            tips = "片头广告";
                            break;
                        case PLVPlayError.PLAY_STAGE_TAILAD:
                            tips = "片尾广告";
                            break;
                        case PLVPlayError.PLAY_STAGE_TEASER:
                            tips = "暖场视频";
                            break;
                        default:
            ...
            videoView.setOnNoLiveAtPresentListener(new IPLVLiveListenerEvent.OnNoLiveAtPresentListener() {
                @Override
            ...
            videoView.setOnPreparedListener(new IPLVVideoViewListenerEvent.OnPreparedListener() {
                @Override
                public void onPrepared() {
                    ...
                    if (videoView.getMediaPlayMode() == PLVMediaPlayMode.MODE_AUDIO) {
                        videoView.removeRenderView();//need clear&unregister
                        setLogoVisibility(View.GONE);
                    } else if (videoView.getMediaPlayMode() == PLVMediaPlayMode.MODE_VIDEO) {
                        setLogoVisibility(View.VISIBLE);
                    }
                    IPLVLivePlayerContract.ILivePlayerView view = getView();
                    if (view != null) {
            ...
            videoView.setOnLinesChangedListener(new IPLVLiveListenerEvent.OnLinesChangedListener() {
                @Override
            ...
            videoView.setOnGetMarqueeVoListener(new IPLVVideoViewListenerEvent.OnGetMarqueeVoListener() {
                @Override
                public void onGetMarqueeVo(PLVLiveMarqueeVO marqueeVo) {
            ...
            videoView.setOnGestureClickListener(new IPLVVideoViewListenerEvent.OnGestureClickListener() {
                @Override
                public void callback(boolean start, boolean end) {
                    //如果当前没有直播，才会将单击事件传递
            ...
            videoView.setOnGestureLeftDownListener(new IPLVVideoViewListenerEvent.OnGestureLeftDownListener() {
                @Override
                public void callback(boolean start, boolean end) {
            ...
            videoView.setOnGestureLeftUpListener(new IPLVVideoViewListenerEvent.OnGestureLeftUpListener() {
                @Override
                public void callback(boolean start, boolean end) {
                    int brightness = videoView.getBrightness((Activity) videoView.getContext()) + 8;
            ...
            videoView.setOnGestureRightDownListener(new IPLVVideoViewListenerEvent.OnGestureRightDownListener() {
                @Override
                public void callback(boolean start, boolean end) {
            ...
            videoView.setOnGestureRightUpListener(new IPLVVideoViewListenerEvent.OnGestureRightUpListener() {
                @Override
                public void callback(boolean start, boolean end) {
                    int volume = videoView.getVolume() + PLVControlUtils.getVolumeValidProgress(videoView.getContext(), 8);
            ...
            videoView.setOnDanmuServerOpenListener(new IPLVLiveListenerEvent.OnDanmuServerOpenListener() {
                @Override
            ...
            videoView.setMicroPhoneListener(new IPLVLiveListenerEvent.MicroPhoneListener() {
                @Override
            ...
            videoView.setOnPPTShowListener(new IPLVVideoViewListenerEvent.OnPPTShowListener() {
                @Override
            ...
            videoView.setOnSupportRTCListener(new IPLVLiveListenerEvent.OnSupportRTCListener() {
                @Override
                public void onSupportRTC(boolean isSupportRTC) {
                    liveRoomDataManager.setSupportRTC(isSupportRTC);
                }
            });
            videoView.setOnSEIRefreshListener(new IPLVVideoViewListenerEvent.OnSEIRefreshListener() {
                @Override
            ...
            videoView.setOnNetworkStateListener(new IPLVVideoViewListenerEvent.OnNetworkStateListener() {
                @Override
            ...
            videoView.setOnGetLogoListener(new IPLVVideoViewListenerEvent.OnGetLogoListener() {
                @Override
            ...
            videoView.setOnVideoPauseListener(new IPLVVideoViewListenerEvent.OnVideoPauseListener() {
                @Override
                public void onPause() {
                    setMarqueeViewRunning(false);
                }
            });
            videoView.setOnOnlyAudioListener(new IPLVLiveListenerEvent.OnOnlyAudioListener() {
                @Override
