...
public interface IPLVLiveRoomDataManager {
     ...
     * 获取直播详情数据LiveData
     */
    LiveData<PLVStatefulData<PLVLiveClassDetailVO>> getClassDetailVO();

    /**
     * 获取功能开关数据LiveData
     */
    LiveData<PLVStatefulData<PLVChatFunctionSwitchVO>> getFunctionSwitchVO();

    /**
     * 获取直播商品数据LiveData
     */
    LiveData<PLVStatefulData<PLVCommodityVO>> getCommodityVO();
