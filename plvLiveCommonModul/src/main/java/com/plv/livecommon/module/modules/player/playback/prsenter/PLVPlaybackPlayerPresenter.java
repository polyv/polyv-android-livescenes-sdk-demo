package com.plv.livecommon.module.modules.player.playback.prsenter;
...
import com.plv.livecommon.module.modules.player.playback.prsenter.data.PLVPlaybackPlayerData;
...
public class PLVPlaybackPlayerPresenter implements IPLVPlaybackPlayerContract.IPlaybackPlayerPresenter {
    ...
    @Override
    public void bindPPTView(IPLVPPTView pptView) {
        if (videoView != null) {
    ...
    public String getVideoName() {
        if (videoView != null) {
            PLVPlaybackVO.DataBean dataBean = videoView.getModleVO();
            if (dataBean != null) {
    ...
    private void initVideoViewListener() {
        if (videoView != null) {
            ...
            videoView.setOnCompletionListener(new IPLVVideoViewListenerEvent.OnCompletionListener() {
                @Override
            ...
            videoView.setOnInfoListener(new IPLVVideoViewListenerEvent.OnInfoListener() {
                @Override
            ...
            videoView.setOnGestureDoubleClickListener(new IPLVVideoViewListenerEvent.OnGestureDoubleClickListener() {
                @Override
            ...
            videoView.setOnGestureSwipeLeftListener(new IPLVVideoViewListenerEvent.OnGestureSwipeLeftListener() {
                @Override
            ...
            videoView.setOnGestureSwipeRightListener(new IPLVVideoViewListenerEvent.OnGestureSwipeRightListener() {
                @Override
                public void callback(boolean start, boolean end, int times) {
                    IPLVPlaybackPlayerContract.IPlaybackPlayerView view = getView();
                    if (videoView.isInPlaybackStateEx()) {
            ...
            videoView.setOnDanmuServerOpenListener(new IPLVVideoViewListenerEvent.OnDanmuServerOpenListener() {
                @Override
            ...
            videoView.setOnRetryListener(new IPLVPlaybackListenerEvent.OnRetryListener() {
                @Override
