...
// </editor-fold>
    ...
    protected void processSocketMsg(String msg, String event) {
        switch (event) {
            //开始抽奖
            case PLVSocketEvent.LOTTERY_START:
                //当前频道正在抽奖
            case PLVSocketEvent.ON_LOTTERY:
                notifyShow();
                ...
                break;
            //停止抽奖
            case PLVSocketEvent.LOTTERY_END:
                final PLVLotteryEndVO vo = PLVGsonUtil.fromJson(PLVLotteryEndVO.class, msg);
                if (vo == null) {
                    return;
                }
                notifyShow();
    ...
    private void sendWinLotteryToServer(String data) {
        ...
        PLVResponseExcutor.excuteDataBean(PLVApiManager.getPlvApichatApi()
                ...
                String.class, new PLVrResponseCallback<String>() {
                    ...
                    public void onSuccess(String s) {
                        ...
                        PLVInteractiveCallbackVO vo = new PLVInteractiveCallbackVO(PLVInteractiveCallbackVO.EVENT_LOTTERY, 200);
                    ...
                    public void onError(Throwable e) {
                        super.onError(e);
                        PLVInteractiveCallbackVO vo = new PLVInteractiveCallbackVO(PLVInteractiveCallbackVO.EVENT_LOTTERY, 400);
                        commonControl.sendServerResultToJs(PLVGsonUtil.toJsonSimple(vo));
