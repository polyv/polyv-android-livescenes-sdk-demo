...
public class PLVMarqueeCommonController {
    ...
    // <editor-fold desc="变量">
    private static final String TAG = "PLVMarqueeController";
     ...
     */
    public void updateMarqueeView(PLVLiveMarqueeVO channelJsonMarqueeVO,
                                  String nickName,
        ...
        switch (channelJsonMarqueeVO.marqueeType) {
            case PLVLiveMarqueeVO.MARQUEETYPE_FIXED:
                ...
                break;
            case PLVLiveMarqueeVO.MARQUEETYPE_NICKNAME:
                ...
                setDefaultMarqueeParams(marqueeModel, nickName,
                        ...
                        defaultSetting, callback);
                break;
            case PLVLiveMarqueeVO.MARQUEETYPE_DIYURL:
