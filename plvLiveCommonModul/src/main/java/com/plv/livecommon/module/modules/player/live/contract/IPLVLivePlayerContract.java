package com.plv.livecommon.module.modules.player.live.contract;
...
public interface IPLVLivePlayerContract {
    ...
    interface ILivePlayerView {
         ...
         * 获取主播放器view
         */
        PLVLiveVideoView getLiveVideoView();
         ...
         * @param tips  错误提示
         */
        void onPlayError(PLVPlayError error, String tips);
         ...
         */
        void onPrepared(@PLVMediaPlayMode.Mode int mediaPlayMode);
    ...
    interface ILivePlayerPresenter {
        ...
        @Nullable
        List<PLVDefinitionVO> getBitrateVO();

        /**
         * 获取播放模式
         *
         * @return @{@link PLVMediaPlayMode.Mode}
         */
         ...
         * 改变播放模式
         */
        void changeMediaPlayMode(@PLVMediaPlayMode.Mode int mediaPlayMode);
