package com.plv.livecommon.module.modules.multirolelinkmic.presenter;
...
import com.plv.livecommon.module.modules.multirolelinkmic.contract.IPLVMultiRoleLinkMicContract;
import com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleEventProcessor;
import com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleLinkMicList;
import com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleMemberList;
import com.plv.livecommon.module.modules.multirolelinkmic.presenter.data.PLVMultiRoleLinkMicData;
import com.plv.livecommon.module.modules.streamer.model.PLVMemberItemDataBean;
...
import static com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleLinkMicConstant.JOIN_CHANNEL_ED;
import static com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleLinkMicConstant.JOIN_CHANNEL_ING;
import static com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleLinkMicConstant.JOIN_CHANNEL_UN;
import static com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleLinkMicConstant.LINK_MIC_INITIATED;
import static com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleLinkMicConstant.LINK_MIC_INITIATING;
import static com.plv.livecommon.module.modules.multirolelinkmic.model.PLVMultiRoleLinkMicConstant.LINK_MIC_UNINITIATED;
...
public class PLVMultiRoleLinkMicPresenter implements IPLVMultiRoleLinkMicContract.IMultiRoleLinkMicPresenter {
    ...
    public void sendCupEvent(int linkMicListPos, final Ack ack) {
        ...
        PLVLinkMicEventSender.getInstance().sendCupEvent(
                ...
                new IPLVLinkMicEventSender.PLVMainCallAck() {
                    @Override
    ...
    public void setPaintPermission(int memberListPos, boolean isHasPermission, final Ack ack) {
        ...
        PLVLinkMicEventSender.getInstance().setPaintPermission(
                memberItemDataBean.getSocketUserBean(),
                liveRoomDataManager.getSessionId(),
                isHasPermission, new IPLVLinkMicEventSender.PLVMainCallAck() {
                    @Override
                    public void onCall(Object... args) {
                        if (ack != null) {
                            ack.call(args);
    ...
    public void setMediaPermission(int memberListPos, final boolean isVideoType, final boolean isMute, final Ack ack) {
        ...
        PLVLinkMicEventSender.getInstance().setMediaPermission(socketUserBean, sessionId, isVideoType, isMute, new IPLVLinkMicEventSender.PLVMainCallAck() {
            @Override
            public void onCall(Object... args) {
    ...
    public void controlUserLinkMic(int memberListPos, boolean isAllowJoin) {
        ...
        if (isAllowJoin) {
            //互动学堂的学生需要确认上麦
            PLVLinkMicEventSender.getInstance().responseUserLinkMic(socketUserBean, true, new IPLVLinkMicEventSender.PLVMainCallAck() {
                @Override
                public void onCall(Object... args) {
    ...
    private void acceptOnSliceStart() {
        ...
        PLVSocketWrapper.getInstance().sendLoginEvent(new IPLVLinkMicEventSender.PLVMainCallAck() {
            @Override
            public void onCall(Object... args) {
                if (isTeacherType) {
