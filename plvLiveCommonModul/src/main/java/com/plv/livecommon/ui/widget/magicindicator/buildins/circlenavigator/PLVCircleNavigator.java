package com.plv.livecommon.ui.widget.magicindicator.buildins.circlenavigator;
...
public class PLVCircleNavigator extends View implements IPLVPagerNavigator {
    ...
    private void init(Context context) {
        ...
        mRadius = PLVUIUtil.dip2px(context, 3);
        mCircleSpacing = PLVUIUtil.dip2px(context, 8);
        mStrokeWidth = PLVUIUtil.dip2px(context, 1);
    }
