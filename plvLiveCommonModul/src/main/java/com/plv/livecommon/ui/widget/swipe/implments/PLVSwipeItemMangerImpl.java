package com.plv.livecommon.ui.widget.swipe.implments;

import android.view.View;


import com.plv.livecommon.ui.widget.swipe.PLVSimpleSwipeListener;
...
/**
 * PLVSwipeItemMangerImpl is a helper class to help all the adapters to maintain open status.
 */
public class PLVSwipeItemMangerImpl implements PLVSwipeItemMangerInterface {
    ...
    public PLVSwipeItemMangerImpl(PLVSwipeAdapterInterface swipeAdapterInterface) {
        if (swipeAdapterInterface == null)
            throw new IllegalArgumentException("PLVSwipeAdapterInterface can not be null");
