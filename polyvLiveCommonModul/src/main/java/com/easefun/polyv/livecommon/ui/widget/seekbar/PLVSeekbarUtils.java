...
public class PLVSeekbarUtils {
    ...
    public static Bitmap drawableToBitmap(Context context, int width, int height, int drawableId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            return PLVSeekbarUtils.drawableToBitmap(width, height, context.getResources().getDrawable(drawableId, null));
        } else {
            return PLVSeekbarUtils.drawableToBitmap(width, height, context.getResources().getDrawable(drawableId));
        }
    }
