 ...
 * relativeImageSpan
 */
public class PLVRelativeImageSpan extends ImageSpan {
	...
	public PLVRelativeImageSpan(Drawable d) {
		super(d);
	}

	public PLVRelativeImageSpan(Drawable d, int verticalAlignment) {
		super(d, verticalAlignment);
		status = verticalAlignment;
	}

	public PLVRelativeImageSpan(Drawable d, int verticalAlignment, float spacingScale) {
		super(d, verticalAlignment);
		status = verticalAlignment;
		scale = spacingScale;
	}
