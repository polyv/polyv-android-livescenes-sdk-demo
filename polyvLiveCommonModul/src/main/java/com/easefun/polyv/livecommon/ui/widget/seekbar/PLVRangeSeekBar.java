...
public class PLVRangeSeekBar extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        try {
            ...
            seekBarMode = t.getInt(R.styleable.PLVRangeSeekBar_rsb_mode, SEEKBAR_MODE_RANGE);
            minProgress = t.getFloat(R.styleable.PLVRangeSeekBar_rsb_min, 0);
            maxProgress = t.getFloat(R.styleable.PLVRangeSeekBar_rsb_max, 100);
            minInterval = t.getFloat(R.styleable.PLVRangeSeekBar_rsb_min_interval, 0);
            gravity = t.getInt(R.styleable.PLVRangeSeekBar_rsb_gravity, Gravity.TOP);
            progressColor = t.getColor(R.styleable.PLVRangeSeekBar_rsb_progress_color, 0xFF4BD962);
            progressRadius = (int) t.getDimension(R.styleable.PLVRangeSeekBar_rsb_progress_radius, -1);
            progressDefaultColor = t.getColor(R.styleable.PLVRangeSeekBar_rsb_progress_default_color, 0xFFD7D7D7);
            progressDrawableId = t.getResourceId(R.styleable.PLVRangeSeekBar_rsb_progress_drawable, 0);
            progressDefaultDrawableId = t.getResourceId(R.styleable.PLVRangeSeekBar_rsb_progress_drawable_default, 0);
            progressHeight = (int) t.getDimension(R.styleable.PLVRangeSeekBar_rsb_progress_height, PLVSeekbarUtils.dp2px(2));
            tickMarkMode = t.getInt(R.styleable.PLVRangeSeekBar_rsb_tick_mark_mode, TRICK_MARK_MODE_NUMBER);
            tickMarkGravity = t.getInt(R.styleable.PLVRangeSeekBar_rsb_tick_mark_gravity, TICK_MARK_GRAVITY_CENTER);
            tickMarkLayoutGravity = t.getInt(R.styleable.PLVRangeSeekBar_rsb_tick_mark_layout_gravity, Gravity.TOP);
            tickMarkTextArray = t.getTextArray(R.styleable.PLVRangeSeekBar_rsb_tick_mark_text_array);
            tickMarkTextMargin = (int) t.getDimension(R.styleable.PLVRangeSeekBar_rsb_tick_mark_text_margin, PLVSeekbarUtils.dp2px(7));
            tickMarkTextSize = (int) t.getDimension(R.styleable.PLVRangeSeekBar_rsb_tick_mark_text_size, PLVSeekbarUtils.dp2px(12));
            tickMarkTextColor = t.getColor(R.styleable.PLVRangeSeekBar_rsb_tick_mark_text_color, progressDefaultColor);
            tickMarkInRangeTextColor = t.getColor(R.styleable.PLVRangeSeekBar_rsb_tick_mark_in_range_text_color, progressColor);
            steps = t.getInt(R.styleable.PLVRangeSeekBar_rsb_steps, 0);
            stepsColor = t.getColor(R.styleable.PLVRangeSeekBar_rsb_step_color, 0xFF9d9d9d);
            stepsRadius = t.getDimension(R.styleable.PLVRangeSeekBar_rsb_step_radius, 0);
            stepsWidth = t.getDimension(R.styleable.PLVRangeSeekBar_rsb_step_width, 0);
            stepsHeight = t.getDimension(R.styleable.PLVRangeSeekBar_rsb_step_height, 0);
            stepsDrawableId = t.getResourceId(R.styleable.PLVRangeSeekBar_rsb_step_drawable, 0);
            stepsAutoBonding = t.getBoolean(R.styleable.PLVRangeSeekBar_rsb_step_auto_bonding, true);

            stepsMidtoSideDrawMod = t.getBoolean(R.styleable.PLVRangeSeekBar_rsb_mid_side_drawable_mode, false);
            t.recycle();
        } catch (Exception e) {
            e.printStackTrace();
        }
