...
public class PLVImageSelectorUtil {
    private static final int REQUEST_CODE_PICK_IMAGES = 10019;
    ...
    public static void handleActivityResult(Context context, int requestCode, int resultCode, Intent data, PLVImageSelectorUtil.ImagePickerCallback callback) {
        if (requestCode == REQUEST_CODE_PICK_IMAGES && resultCode == Activity.RESULT_OK && data != null) {
            ...
            if (callback != null && imagePaths.size() > 0) {
