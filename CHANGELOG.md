...
优化：
1. 【连麦】增加连麦面板隐藏和展开按钮 [Demo]

### 【手机开播（全场景）】

新增：
1. 【合规】兼容主播嘉宾合规提醒 [Demo、Common、SDK]

优化：
1. 【连麦】响应观众连麦默认开启 [Demo、Common、SDK]
...
修复：
1. 【跑马灯】修复由手机配置导致的跑马灯快速闪烁/乱跳 [Common]

### 【手机开播（全场景）】

新增：
1. 【推流】支持RTMP和SRT推流 [Common、SDK]
...
新增：
1. 【福袋】支持参与福袋活动 [Demo、Common、SDK]

优化：
1. 【直播间】访问次数响应后台配置 [Demo、SDK]

修复：
1. 【跑马灯】修复部分机型跑马灯快速闪烁/乱跳 [Common]

### 【手机开播（全场景）】

新增：
1. 【福袋】支持发起福袋活动 [Demo、Common、SDK]
2. 【聊天室】支持踢出、禁言列表 [Demo、Common、SDK]
...
优化：
1. 【商品库】支持显示商品自定义价格 [Demo、SDK]
2. 【商品库】商品大卡片改造 [Common、SDK]

修复：
1. 【抽奖】修复抽奖挂件倒计时文案错误 [Common]
2. 【小窗】修复首次获取悬浮窗权限后，小窗没有显示的问题 [Demo]

### 【手机开播（全场景）】

修复：
1. 【优化】修复已知问题 [Demo、Common、SDK]
...
新增：
1. 【商品库】自定义购买价格商品支持配置秒杀价 [Demo、SDK]

### 【手机开播（全场景）】

新增：
1. 【开播】支持音频审核违规提醒 [Demo、Common、SDK]
...
新增：
1. 【商品库】响应商品消息特效配置 [Demo、Common、SDK]
...
新增：
1. 【商品库】支持显示秒杀价格 [Demo、Common、SDK]

优化：
1. 【商品库】响应商品热卖特效配置 [Demo、SDK]

### 【手机开播（全场景）】

新增：
1. 【开播】支持绿幕抠像 [Demo、Common、SDK]
2. 【连麦】小班课新增「观众主动上麦」开关 [Demo、Common、SDK]
...
新增：
1. 【互动】新增答题卡入口 [Demo、Common、SDK]

### 【手机开播（纯视频）场景】

新增：
1. 【开播】新增模版功能 [Demo、Common、SDK]
...
新增：
1. 【互动】新增「我的奖励」功能，提升互动体验 [Demo、Common、SDK]
2. 【小窗】小窗支持贴边收起和缩放 [Common]

### 【观看端（直播带货）场景】

修复:
1. 【直播间】修复加载错误聊天背景图导致空指针报错 [Demo]

### 【手机开播（全场景）】

新增：
1. 【聊天室】新增支持可靠消息机制 [Common、SDK]
...
新增：
1. 【观看】新增支持小班课场景 [Demo、SDK]
2. 【外链】新增外链跳转携带参数 [Demo、Common]
3. 【直播】支持自定义token鉴权 [SDK]

优化：
1. 【统计】优化观看数据统计的定时器逻辑 [SDK]

### 【手机开播（全场景）】

优化：
1. 【开播】新增支持小班课场景 [SDK]
2. 【屏幕共享】优化底层屏幕共享参数控制 [SDK]

## 【手机开播（纯视频）场景】

新增：

1. 【开播】新增支持设置封面 [Demo、Common、SDK]
...
新增：
1. 【字幕】新增实时字幕显示功能 [Demo、Common、SDK]
2. 【登录】登录频道支持自动选择后台配置的观看模板 [Demo、SDK]

### 【SDK】

优化：
1. 【Socket】优化Socket重连稳定性 [SDK]
...
新增：
1. 【聊天室】被回复时消息高亮处理 [Demo、Common]

### 【观看端（直播带货）场景】

新增:
1. 【连麦】已连麦观众背景跟随页面装修聊天室背景设置 [Demo]

### 【手机开播（全场景）】

新增：
1. 【成员】成员列表响应后台频道角色权限开关 [Demo]

优化：
1. 【屏幕共享】优化屏幕共享分辨率自适应逻辑 [SDK]

### 【手机开播（纯视频）场景】

新增：
1. 【回放】直播回放入口响应后台开关 [Demo、Common]

优化：
1. 【AI手卡】优化AI手卡弹出逻辑 [Demo、Common]

### 【SDK】

优化：
1. 【SDK】优化 HttpDns 调用逻辑 [SDK]
...
新增:
1. 【连麦】支持1v1连麦布局 [Demo、Common、SDK]

### 【SDK】

优化：
1. 【SDK】完善播放器elog信息收集 [SDK]
...
新增:
1. 【美颜】美颜新增红唇、额头调整功能 [Demo、Common、SDK]

优化
1. 【开播】屏幕共享听从超管码率限制 [SDK]
2. 【商品库】AI手卡没内容时不显示空弹窗 [Demo、Common、SDK]
...
新增功能:
1. 【商品库】支持商品详情 [Demo、Common、SDK]
2. 【商品库】支持商品讲解 [Demo、Common、SDK]
3. 【商品库】小卡片支持响应管理后台商品设置外链购买 [Demo、SDK]
4. 【回放】支持直播回放时移看点 [Demo、Common、SDK]
5. 【PPT】回放支持响应管理后台观看页布局设置 [Demo]
6. 【聊天室】支持隐藏观众昵称 [Demo、Common、SDK]
...
2. 【商品库】支持商品讲解 [Demo、Common、SDK]
3. 【商品库】小卡片支持响应管理后台商品设置外链购买 [Demo、SDK]
4. 【播放器】直播带货场景回放支持字幕显示 [Demo、Common、SDK]
5. 【聊天室】支持隐藏观众昵称 [Demo、Common、SDK]

### 【开播端（三分屏）场景】

新增功能:
1. 【美颜】美颜新增瘦鼻、嘴巴、美牙调整功能 [Demo、SDK]

### 【开播端（纯视频）场景】

新增功能:
1. 【商品库】对齐移动中控商品库功能 [Demo、SDK]
2. 【商品库】新增 AI 商品讲解 [Demo、Common、SDK]
3. 【商品库】支持韩文 [Demo、SDK]
4. 【美颜】美颜新增瘦鼻、嘴巴、美牙调整功能 [Demo、SDK]

### 【SDK】

新增功能:
1. 【连麦】连麦画面响应后台设置 [Common、SDK]
2. 适配16kb page size [SDK]
3. 适配Android15 & Android16 [Demo、Common、SDK]
...
新增：
1. 【直播】支持响应测试模式 [SDK]
2. 【回放】支持下载m3u8视频 [Common、SDK]
3. 【回放】支持点播加密视频播放和缓存 [Common、SDK]
4. 【投屏】支持直播投屏 [Demo、Common、SDK]

优化:
1. 【回放】聊天记录加载关联场次Id [Demo、Common、SDK]
2. 【回放】聊天重放不再关联直播状态 [SDK]
3. 【播放器】修复相对路径m3u8视频在httpdns播放失败的问题 [SDK]

### 【开播端（纯视频）场景】

新增：
1. 【开播】支持播放本地视频 [Demo、Common、SDK]
2. 【聊天室】支持在评论区禁言和踢出观众 [Demo、Common、SDK]
3. 【连麦】支持设置连麦布局背景 [Demo、Common]

### 【开播端（三分屏）场景】

新增：
1. 【聊天室】支持在评论区禁言和踢出观众 [Demo、Common、SDK]
2. 【连麦】支持设置连麦布局背景 [Demo、Common]

优化：
1. 【登录】修复传入讲师昵称时会显示多出一串数字 [Demo]
