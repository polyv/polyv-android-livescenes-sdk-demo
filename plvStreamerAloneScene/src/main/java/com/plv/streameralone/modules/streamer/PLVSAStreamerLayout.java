...
import com.plv.livecommon.ui.widget.PLVMultiModeRecyclerViewLayout;
import com.plv.livecommon.ui.widget.PLVNoInterceptTouchRecyclerView;
import com.plv.livescenes.streamer.IPLVStreamerManager;
import com.plv.livescenes.streamer.config.PLVStreamerConfig;
import com.plv.streameralone.R;
import com.plv.streameralone.modules.streamer.adapter.PLVSAStreamerAdapter;
...
public class PLVSAStreamerLayout extends FrameLayout implements IPLVSAStreamerLayout {
    ...
    private void initView() {
        ...
        //启动前台服务，防止在后台被杀
        PLVForegroundService.startForegroundService(PLVSAStreamerAloneActivity.class, "手机开播", R.drawable.plvsa_ic_launcher);
        //防止自动息屏、锁屏
    ...
    private PLVAbsStreamerView streamerView = new PLVAbsStreamerView() {
        ...
        public void onStreamerEngineCreatedSuccess(String linkMicUid, List<PLVLinkMicItemDataBean> linkMicList) {
            ...
            streamerPresenter.setMixLayoutType(PLVStreamerConfig.MixStream.MIX_LAYOUT_TYPE_TILE);
