 ...
 */
public class PLVSAEmotionPersonalListAdapter extends RecyclerView.Adapter<PLVSAEmotionPersonalListAdapter.PersonalItemViewHolder> {
    // <editor-fold defaultstate="collapsed" desc="变量">
    private List<PLVEmotionImageVO.EmotionImage> emotionPersonalList;
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="构造器">
    public PLVSAEmotionPersonalListAdapter(List<PLVEmotionImageVO.EmotionImage> emotionImages) {
    ...
    public PersonalItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PersonalItemViewHolder
                (LayoutInflater.from(parent.getContext()).inflate(R.layout.plvsa_chatroom_emoji_personal_item, parent, false));
