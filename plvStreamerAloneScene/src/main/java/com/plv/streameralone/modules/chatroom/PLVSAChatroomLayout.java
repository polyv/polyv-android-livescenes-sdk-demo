package com.plv.streameralone.modules.chatroom;
...
import com.plv.streameralone.modules.chatroom.adapter.holder.PLVSAMessageViewHolder;
import com.plv.streameralone.modules.chatroom.widget.PLVSAChatMsgInputWindow;
    ...
    private boolean sendChatMessage(String message) {
        if (message.trim().length() == 0) {
            ...
            if (sendResult.first) {
                ...
                if (PLVLocalMessage.SENDVALUE_NOONLINE == sendResult.second) {
