...
import com.plv.livecommon.ui.widget.gif.GifSpanTextView;
...
import com.plv.livecommon.module.utils.span.PLVRadiusBackgroundSpan;
...
import com.plv.streameralone.modules.chatroom.widget.PLVSAChatMsgTipsWindow;
    ...
    private void initView() {
        ...
        if(failedImageTipIv != null){
            failedImageTipIv.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (localImgStatus == PLVSendLocalImgEvent.SENDSTATUS_FAIL) {
        ...
        PLVChatroomManager.getInstance().addSendChatImageListener(new PLVSendChatImageListener() {
            ...
            public void onCheckFail(PLVSendLocalImgEvent localImgEvent, Throwable t) {
                ...
                if (localImgEvent == messageData) {
                    ...
                    ((PLVSendLocalImgEvent) messageData).setObj1(localImgFailMessage);
