 ...
 * 表情列表适配器
 */
public class PLVSAEmojiListAdapter extends RecyclerView.Adapter<PLVSAEmojiListAdapter.EmojiItemViewHolder> {
    // <editor-fold defaultstate="collapsed" desc="变量">
    private List<String> emoLists;
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="构造器">
    public PLVSAEmojiListAdapter() {
    ...
    public EmojiItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new EmojiItemViewHolder
                (LayoutInflater.from(parent.getContext()).inflate(R.layout.plvsa_chatroom_chat_emoji_gridview_item, parent, false));
    }
