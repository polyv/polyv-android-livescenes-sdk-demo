package com.plv.streameralone.modules.chatroom.adapter;
...
import com.plv.streameralone.modules.chatroom.adapter.holder.PLVSAMessageRewardViewHolder;
...
public class PLVSAMessageAdapter extends PLVBaseAdapter<PLVBaseViewData, PLVBaseViewHolder<PLVBaseViewData, PLVSAMessageAdapter>> {
    ...
    public void notifyProhibitedChanged(String prohibitedMessage, String hintMsg, String status) {
        ...
        for (int i = fullDataList.size() - 1; i >= 0; i--) {
            ...
            if (baseViewData.getData() instanceof PLVLocalMessage) {
                String speakMsg = ((PLVLocalMessage) baseViewData.getData()).getSpeakMessage();
                if (prohibitedMessage != null && speakMsg != null && speakMsg.contains(prohibitedMessage)) {
                    ...
                    ((PLVLocalMessage) baseViewData.getData()).setProhibitedWord(prohibitedWordVO);
