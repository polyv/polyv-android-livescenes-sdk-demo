...
public class PLVECProductClickTipsView extends FrameLayout {
    private static final String TAG = "PLVECProductClickTipsView";
    ...
    public PLVECProductClickTipsView(@NonNull Context context) {
        this(context, null);
    }

    public PLVECProductClickTipsView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PLVECProductClickTipsView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        View.inflate(getContext(), R.layout.plvec_chat_product_click_tips_layout, this);
