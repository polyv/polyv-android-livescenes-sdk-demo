...
public class PLVECChatMessageProductClickViewHolder extends PLVECChatMessageCommonViewHolder<PLVBaseViewData, PLVECChatMessageAdapter> {
    private TextView productClickTipsTv;

    public PLVECChatMessageProductClickViewHolder(View itemView, PLVECChatMessageAdapter adapter) {
