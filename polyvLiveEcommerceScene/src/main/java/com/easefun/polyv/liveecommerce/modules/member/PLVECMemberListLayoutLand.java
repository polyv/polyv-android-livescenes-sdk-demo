 ...
 * @author Hoshiiro
 */
public class PLVECMemberListLayoutLand extends FrameLayout {
    ...
    public PLVECMemberListLayoutLand(@NonNull Context context) {
        super(context);
        initView();
    }

    public PLVECMemberListLayoutLand(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PLVECMemberListLayoutLand(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.plvec_member_list_layout_land, this);
