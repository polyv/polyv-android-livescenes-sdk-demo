package com.plv.liveecommerce.modules.player;
...
import com.plv.business.api.common.player.PLVPlayerScreenRatio;
...
import com.plv.livecommon.module.modules.marquee.PLVMarqueeView;
import com.plv.livecommon.module.modules.watermark.IPLVWatermarkView;
import com.plv.livecommon.module.modules.player.PLVEmptyMediaController;
...
import com.plv.livecommon.module.modules.player.live.presenter.PLVLivePlayerPresenter;
import com.plv.livecommon.module.modules.player.live.view.PLVAbsLivePlayerView;
import com.plv.livecommon.module.modules.player.playback.prsenter.data.PLVPlayInfoVO;
import com.plv.livecommon.module.modules.watermark.PLVWatermarkView;
import com.plv.livecommon.module.utils.PLVVideoSizeUtils;
import com.plv.livecommon.module.utils.imageloader.PLVImageLoader;
import com.plv.livecommon.ui.widget.PLVPlayerLogoView;
import com.plv.livecommon.ui.widget.magicindicator.buildins.PLVUIUtil;
import com.plv.liveecommerce.R;
import com.plv.liveecommerce.modules.player.constant.PLVECFitMode;
import com.plv.liveecommerce.modules.player.rtc.IPLVECLiveRtcVideoLayout;
...
public class PLVECLiveVideoLayout extends FrameLayout implements IPLVECVideoLayout, View.OnClickListener {
    ...
    //音频模式view
    private IPLVLiveAudioModeView audioModeView;
    //控制器
    private IPLVMediaController mediaController;
    //播放器缓冲显示的view
        ...
        onSubVideoViewLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (subVideoView.getAdHeadImage() != null) {
                    ...
                    if (subVideoView.getAspectRatio() == PLVPlayerScreenRatio.AR_ASPECT_FIT_PARENT) {
    ...
    public View detachVideoViewParent() {
        ...
        videoView.setAspectRatio(PLVPlayerScreenRatio.AR_ASPECT_FIT_PARENT);
        subVideoView.setAspectRatio(PLVPlayerScreenRatio.AR_ASPECT_FIT_PARENT);
        //调整手势配置
    ...
    @Override
    public LiveData<com.plv.livecommon.module.modules.player.live.presenter.data.PLVPlayInfoVO> getLivePlayInfoVO() {
    ...
    private IPLVLivePlayerContract.ILivePlayerView livePlayerView = new PLVAbsLivePlayerView() {
        ...
        public void onPrepared(int mediaPlayMode) {
            ...
            if (mediaPlayMode == PLVMediaPlayMode.MODE_VIDEO) {
            ...
            } else if (mediaPlayMode == PLVMediaPlayMode.MODE_AUDIO) {
                fitMode = PLVECFitMode.FIT_VIDEO_RECT_FALSE;
                if (!isVideoViewParentDetachVideoLayout) {
                    PLVVideoSizeUtils.fitVideoRect(false, videoView.getParent(), videoViewRect);
                }
        ...
        @Override
        public void updatePlayInfo(com.plv.livecommon.module.modules.player.live.presenter.data.PLVPlayInfoVO playInfoVO) {
