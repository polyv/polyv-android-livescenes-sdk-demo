package com.plv.liveecommerce.modules.commodity;
...
public class PLVECCommodityPopupView {
    ...
    private PLVCommodityVO commodityVO;
    ...
    public void setCommodityVO(PLVCommodityVO commodityVO) {
    ...
    public void addCommodityVO(PLVCommodityVO commodityVO) {
        if (commodityVO == null) {
    ...
    private List<PLVBaseViewData> toViewDataList(PLVCommodityVO commodityVO) {
