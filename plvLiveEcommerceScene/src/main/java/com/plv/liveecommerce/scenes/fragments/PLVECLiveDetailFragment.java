...
public class PLVECLiveDetailFragment extends PLVBaseFragment {
    ...
    public void setClassDetailVO(PLVLiveClassDetailVO liveClassDetailVO) {
        if (liveClassDetailVO == null) {
            return;
        }
        for (PLVLiveClassDetailVO.DataBean.ChannelMenusBean channelMenusBean : liveClassDetailVO.getData().getChannelMenus()) {
    ...
    public void setBulletinVO(PLVBulletinVO bulletinVO) {
        if (bulletinVO != null) {
    ...
    private void showBulletin(PLVBulletinVO bulletinVO) {
