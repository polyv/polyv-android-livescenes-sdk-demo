...
import com.plv.livecommon.module.modules.chatroom.view.PLVAbsChatroomView;
import com.plv.livecommon.module.modules.player.PLVPlayerState;
import com.plv.livecommon.module.utils.span.PLVRelativeImageSpan;
import com.plv.livecommon.ui.widget.PLVMessageRecyclerView;
...
import com.plv.liveecommerce.modules.chatroom.PLVECChatMessageAdapter;
import com.plv.liveecommerce.modules.chatroom.widget.PLVECBulletinView;
import com.plv.liveecommerce.modules.chatroom.widget.PLVECChatImgScanPopupView;
import com.plv.liveecommerce.modules.chatroom.widget.PLVECChatInputWindow;
import com.plv.liveecommerce.modules.chatroom.widget.PLVECGreetingView;
import com.plv.liveecommerce.modules.chatroom.widget.PLVECLikeIconView;
import com.plv.liveecommerce.modules.commodity.PLVECCommodityAdapter;
import com.plv.liveecommerce.modules.commodity.PLVECCommodityDetailActivity;
import com.plv.liveecommerce.modules.commodity.PLVECCommodityPopupView;
import com.plv.liveecommerce.modules.commodity.PLVECCommodityPushLayout;
import com.plv.liveecommerce.modules.reward.PLVECRewardGiftAdapter;
import com.plv.liveecommerce.modules.reward.PLVECRewardPopupView;
import com.plv.liveecommerce.modules.reward.widget.PLVECRewardGiftAnimView;
import com.plv.liveecommerce.scenes.fragments.widget.PLVECMorePopupView;
import com.plv.liveecommerce.scenes.fragments.widget.PLVECWatchInfoView;
...
public class PLVECLiveHomeFragment extends PLVECCommonHomeFragment implements View.OnClickListener {
    ...
    public void setPlayerState(PLVPlayerState state) {
        if (state == PLVPlayerState.PREPARED) {
            ...
            if (onViewActionListener != null) {
                ...
                int isPlayModeViewVisibility = onViewActionListener.onGetMediaPlayModeAction() == PLVMediaPlayMode.MODE_VIDEO ? View.VISIBLE : View.GONE;
            ...
            morePopupView.updateDefinitionView(onViewActionListener == null ?
                    new Pair<List<PLVDefinitionVO>, Integer>(null, 0) :
    ...
    private void acceptBulletinMessage(final PLVBulletinVO bulletinVO) {
    ...
    private IPLVChatroomContract.IChatroomView chatroomView = new PLVAbsChatroomView() {
        ...
        @Override
        public void onBulletinEvent(@NonNull PLVBulletinVO bulletinVO) {
        ...
        @Override
        public void onLocalSpeakMessage(@Nullable PLVLocalMessage localMessage) {
    ...
    private void showInputWindow() {
        PLVECChatInputWindow.show(getActivity(), PLVECChatInputWindow.class, new PLVInputWindow.InputListener() {
            ...
            public boolean onSendMsg(String message) {
                PLVLocalMessage localMessage = new PLVLocalMessage(message);
    ...
    private void showRewardLayout(View v) {
        rewardPopupView.showRewardLayout(v, new PLVECRewardGiftAdapter.OnViewActionListener() {
            ...
            public void onRewardClick(View view, PLVCustomGiftBean giftBean) {
                ...
                String nickName = PLVSocketWrapper.getInstance().getLoginVO().getNickName();
    ...
    private void showMorePopupWindow(View v) {
        boolean isCurrentVideoMode = onViewActionListener == null || onViewActionListener.onGetMediaPlayModeAction() == PLVMediaPlayMode.MODE_VIDEO;
        morePopupView.showLiveMoreLayout(v, isCurrentVideoMode, new PLVECMorePopupView.OnLiveMoreClickListener() {
            ...
            public boolean onPlayModeClick(View view) {
                if (onViewActionListener != null) {
                    onViewActionListener.onChangeMediaPlayModeClick(view, view.isSelected() ? PLVMediaPlayMode.MODE_VIDEO : PLVMediaPlayMode.MODE_AUDIO);
                    return true;
                }
                return false;
            }
            ...
            @Override
            public Pair<List<PLVDefinitionVO>, Integer> onShowDefinitionClick(View view) {
                return onViewActionListener == null ? new Pair<List<PLVDefinitionVO>, Integer>(null, 0)
                        : onViewActionListener.onShowDefinitionClick(view);
            }
    ...
    public interface OnViewActionListener extends PLVECCommonHomeFragment.OnViewActionListener {
        ...
        //[清晰度信息，清晰度索引]
        Pair<List<PLVDefinitionVO>, Integer> onShowDefinitionClick(View view);
