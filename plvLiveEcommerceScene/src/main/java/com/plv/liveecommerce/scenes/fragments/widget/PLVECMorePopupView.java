package com.plv.liveecommerce.scenes.fragments.widget;
...
public class PLVECMorePopupView {
    ...
    public void showLiveMoreLayout(final View v, boolean isCurrentVideoMode, final OnLiveMoreClickListener clickListener) {
        ...
        if (liveMorePopupWindow == null) {
            ...
            ((ViewGroup) changeDefinitionIv.getParent()).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (clickListener != null) {
                        Pair<List<PLVDefinitionVO>, Integer> listIntegerPair = clickListener.onShowDefinitionClick(changeDefinitionIv);
    ...
    public void updateDefinitionView(final Pair<List<PLVDefinitionVO>, Integer> listIntegerPair) {
    ...
    public void showDefinitionChangeLayout(View v, Pair<List<PLVDefinitionVO>, Integer> listIntegerPair) {
