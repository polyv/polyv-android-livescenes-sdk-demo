package com.plv.livecloudclass.scenes;
...
import com.plv.livecloudclass.modules.linkmic.IPLVLCLinkMicLayout;
import com.plv.livecloudclass.modules.linkmic.PLVLCLinkMicControlBar;
import com.plv.livecloudclass.modules.liveroom.PLVLCLiveLandscapeChannelController;
import com.plv.livecloudclass.modules.media.IPLVLCMediaLayout;
import com.plv.livecloudclass.modules.pagemenu.IPLVLCLivePageMenuLayout;
import com.plv.livecloudclass.modules.ppt.IPLVLCFloatingPPTLayout;
import com.plv.livecloudclass.modules.ppt.IPLVLCPPTView;
...
import com.plv.livecommon.module.utils.PLVDialogFactory;
import com.plv.livecommon.module.utils.PLVViewSwitcher;
...
public class PLVLCCloudClassActivity extends PLVBaseActivity {
    ...
    private void observeMediaLayout() {
        ...
        if (liveRoomDataManager.getConfig().isLive()) {
            ...
            mediaLayout.setOnRTCPlayEventListener(new IPLVLiveListenerEvent.OnRTCPlayEventListener() {
                @Override
