...
import com.plv.livecloudclass.modules.chatroom.adapter.PLVLCMessageAdapter;
...
public class PLVLCQuizFragment extends PLVInputFragment implements View.OnClickListener {
    ...
    private IPLVChatroomContract.IChatroomView chatroomView = new PLVAbsChatroomView() {
        ...
        @Override
        public void onLocalQuestionMessage(@Nullable PLVQuestionMessage questionMessage) {
    ...
    private boolean sendQuestionMessage(String message) {
        if (message.trim().length() == 0) {
            ...
            PLVQuestionMessage questionMessage = new PLVQuestionMessage(message);
            if (chatroomPresenter == null) {
                return false;
            }
