package com.plv.livecloudclass.modules.pagemenu;
...
import com.plv.livecloudclass.modules.chatroom.PLVLCChatFragment;
import com.plv.livecloudclass.modules.chatroom.PLVLCQuizFragment;
import com.plv.livecloudclass.modules.chatroom.adapter.PLVLCChatCommonMessageList;
import com.plv.livecloudclass.modules.chatroom.adapter.holder.PLVLCMessageViewHolder;
import com.plv.livecloudclass.modules.pagemenu.desc.PLVLCLiveDescFragment;
import com.plv.livecloudclass.modules.pagemenu.iframe.PLVLCIFrameFragment;
import com.plv.livecloudclass.modules.pagemenu.previous.PLVLCPlaybackChapterFragment;
import com.plv.livecloudclass.modules.pagemenu.previous.PLVLCPlaybackPreviousFragment;
import com.plv.livecloudclass.modules.pagemenu.question.PLVLCQAFragment;
import com.plv.livecloudclass.modules.pagemenu.text.PLVLCTextFragment;
import com.plv.livecloudclass.modules.pagemenu.tuwen.PLVLCTuWenFragment;
...
import com.plv.livecommon.module.modules.previous.contract.IPLVPreviousPlaybackContract;
import com.plv.livecommon.module.modules.previous.presenter.PLVPreviousPlaybackPresenter;
...
import com.plv.livecommon.module.utils.imageloader.glide.progress.PLVMyProgressManager;
import com.plv.livecommon.module.utils.listener.IPLVOnDataChangedListener;
import com.plv.livecommon.ui.widget.itemview.adapter.PLVViewPagerAdapter;
import com.plv.livecommon.ui.widget.magicindicator.PLVMagicIndicator;
import com.plv.livecommon.ui.widget.magicindicator.PLVViewPagerHelper;
import com.plv.livecommon.ui.widget.magicindicator.buildins.commonnavigator.PLVCommonNavigator;
import com.plv.livecommon.ui.widget.magicindicator.buildins.commonnavigator.abs.IPLVPagerIndicator;
import com.plv.livecommon.ui.widget.magicindicator.buildins.commonnavigator.abs.IPLVPagerTitleView;
import com.plv.livecommon.ui.widget.magicindicator.buildins.commonnavigator.abs.PLVCommonNavigatorAdapter;
import com.plv.livecommon.ui.widget.magicindicator.buildins.commonnavigator.indicators.PLVLinePagerIndicator;
import com.plv.livecommon.ui.widget.magicindicator.buildins.commonnavigator.titles.PLVColorTransitionPagerTitleView;
import com.plv.livecommon.ui.widget.magicindicator.buildins.commonnavigator.titles.PLVSimplePagerTitleView;
...
public class PLVLCLivePageMenuLayout extends FrameLayout implements IPLVLCLivePageMenuLayout {
     ...
     *
     * @param messageList
     * @see #addChatTab(PLVLiveClassDetailVO.DataBean.ChannelMenusBean)
     */
     ...
     *
     * @param presenter
     * @see #addQuizTab(PLVLiveClassDetailVO.DataBean.ChannelMenusBean)
     */
    ...
    private void addDescTab(PLVLiveClassDetailVO liveClassDetail, PLVLiveClassDetailVO.DataBean.ChannelMenusBean channelMenusBean) {
    ...
    private void addQuizTab(PLVLiveClassDetailVO.DataBean.ChannelMenusBean channelMenusBean) {
        pageMenuTabTitleList.add(channelMenusBean.getName());
        if (quizFragment == null) {
    ...
    private void addChatTab(PLVLiveClassDetailVO.DataBean.ChannelMenusBean channelMenusBean) {
        pageMenuTabTitleList.add(channelMenusBean.getName());
        if (chatFragment == null) {
