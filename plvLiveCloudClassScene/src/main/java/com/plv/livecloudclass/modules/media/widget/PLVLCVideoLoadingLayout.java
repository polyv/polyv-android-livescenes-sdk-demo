...
import com.plv.business.api.common.player.PLVPlayType;
import com.plv.foundationsdk.utils.PLVScreenUtils;
import com.plv.livecloudclass.R;
import com.plv.livecommon.module.utils.PLVViewLocationSensor;
...
public class PLVLCVideoLoadingLayout extends FrameLayout {
    ...
    private IPLVBaseVideoView videoView;
    ...
    private Handler handler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                if (videoView instanceof PLVLiveVideoView ||
                        (videoView instanceof PLVPlaybackVideoView && ((PLVPlaybackVideoView) videoView).getPlayType() == PLVPlayType.ONLINE_PLAY)) {
...
// </editor-fold>
    ...
    public void bindVideoView(IPLVBaseVideoView videoView) {
