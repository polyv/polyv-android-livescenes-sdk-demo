...
import com.plv.livecommon.module.modules.ppt.contract.IPLVLiveFloatingContract;
import com.plv.livecommon.module.modules.ppt.presenter.PLVLiveFloatingPresenter;
...
public class PLVLCFloatingPPTLayout extends FrameLayout implements IPLVLiveFloatingContract.IPLVLiveFloatingView, IPLVLCFloatingPPTLayout {
    ...
    public void show() {
        ...
        if (isServerEnablePPT && !PLVLinkMicConfig.getInstance().isPureRtcWatchEnabled()) {
