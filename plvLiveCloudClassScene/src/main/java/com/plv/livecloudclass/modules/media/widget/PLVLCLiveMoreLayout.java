package com.plv.livecloudclass.modules.media.widget;
...
import com.plv.livecommon.ui.widget.PLVOrientationSensibleLinearLayout;
...
public class PLVLCLiveMoreLayout {
    ...
    public void initBitrate(List<PLVDefinitionVO> bitrateVO, int bitratePos) {
    ...
    public void updateViewWithPlayInfo(@PLVMediaPlayMode.Mode int mediaPlayMode, Pair<List<PLVDefinitionVO>, Integer> listIntegerPair, int[] lines) {
    ...
    public void updateViewWithPlayMode(@PLVMediaPlayMode.Mode int mediaPlayMode) {
        isAudioMode = mediaPlayMode == PLVMediaPlayMode.MODE_AUDIO;
        if (isAudioMode) {
            showBitrate(false);
        }
    ...
    private class RvBitrateAdapter extends RecyclerView.Adapter<RvBitrateAdapter.RvMoreViewHolder> {
        ...
        private List<PLVDefinitionVO> bitrateVO;

        void updateBitrateListData(List<PLVDefinitionVO> bitrateVO, int bitratePos) {
            this.bitrateVO = bitrateVO == null ? new ArrayList<PLVDefinitionVO>() : bitrateVO;
    ...
    public interface OnBitrateSelectedListener {
        void onBitrateSelected(PLVDefinitionVO definitionVO, int pos);
    }
