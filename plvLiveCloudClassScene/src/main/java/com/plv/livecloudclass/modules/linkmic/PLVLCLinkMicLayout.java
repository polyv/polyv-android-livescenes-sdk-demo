package com.plv.livecloudclass.modules.linkmic;
...
import com.plv.livecloudclass.modules.linkmic.adapter.PLVLinkMicListAdapter;
import com.plv.livecloudclass.modules.linkmic.widget.PLVLinkMicRvLandscapeItemDecoration;
...
import com.plv.livecommon.module.modules.linkmic.presenter.PLVLinkMicPresenter;
import com.plv.livecommon.module.utils.PLVForegroundService;
import com.plv.livecommon.module.utils.PLVNotchUtils;
...
// </editor-fold>
    ...
    private void observeOnAudioState(final IPLVLiveRoomDataManager liveRoomDataManager) {
        ...
        liveRoomDataManager.getClassDetailVO().observe((LifecycleOwner) getContext(), new Observer<PLVStatefulData<PLVLiveClassDetailVO>>() {
            @Override
            public void onChanged(@Nullable PLVStatefulData<PLVLiveClassDetailVO> liveClassDetailVOPLVStatefulData) {
                liveRoomDataManager.getClassDetailVO().removeObserver(this);
                if (liveClassDetailVOPLVStatefulData == null || !liveClassDetailVOPLVStatefulData.isSuccess()) {
                    return;
                }
                PLVLiveClassDetailVO liveClassDetail = liveClassDetailVOPLVStatefulData.getData();
