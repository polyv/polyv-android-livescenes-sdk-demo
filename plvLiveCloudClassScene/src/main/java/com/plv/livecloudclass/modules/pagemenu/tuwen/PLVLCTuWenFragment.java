package com.plv.livecloudclass.modules.pagemenu.tuwen;
...
import com.plv.livescenes.feature.pagemenu.PLVTuWenWebView;
...
public class PLVLCTuWenFragment extends PLVBaseFragment {
    ...
    //图文webView
    private PLVTuWenWebView tuWenWebView;
    //webView的父控件
    ...
    private void initView() {
        parentLy = findViewById(com.plv.livecommon.R.id.parent_ly);
        parentLy.setBackgroundColor(Color.parseColor("#141518"));
        tuWenWebView = new PLVTuWenWebView(getContext());
