package com.plv.livecloudclass.modules.pagemenu.desc;
...
public class PLVLCLiveDescFragment extends PLVBaseFragment {
    ...
    public void init(PLVLiveClassDetailVO classDetailVO) {
 ...
 */
    ...
    private void setDescContent() {
        ...
        for (PLVLiveClassDetailVO.DataBean.ChannelMenusBean channelMenusBean : classDetailVO.getData().getChannelMenus()) {
