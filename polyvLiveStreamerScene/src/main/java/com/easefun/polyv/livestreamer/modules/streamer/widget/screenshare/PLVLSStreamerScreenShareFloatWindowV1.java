...
public class PLVLSStreamerScreenShareFloatWindowV1 implements IPLVLSStreamerScreenShareFloatWindow, View.OnClickListener {
    ...
    private void collapse(final View view) {
        final int viewWidth = ConvertUtils.dp2px(74);
        final Point floatLocation = PLVFloatingWindowManager.getInstance().getFloatLocation();
        final int targetX = ScreenUtils.getScreenWidth() - (this.view.getWidth() - view.getWidth());
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                if (interpolatedTime == 1) {
                    ...
                    if (floatLocation != null) {
                        PLVFloatingWindowManager.getInstance().updateFloatLocation(targetX, floatLocation.y);
                    }
                }
