...
public class PLVLSMessageViewHolder extends PLVChatMessageBaseViewHolder<PLVBaseViewData, PLVLSMessageAdapter> {
    ...
    private void onLongClickMessage() {
        ...
        final boolean isFileShareMessage = speakFileData != null;
        ...
        final boolean canCopy = !isImageMessage && !isFileShareMessage;
        final boolean canReply = !isManagerChatMessage && !isProhibited;
        ...
        PLVChatMessagePopupMenu.show(itemView, new PLVChatMessagePopupMenuActions.Builder()
                ...
                .setKick(new PLVChatMessagePopupMenuAction(
                        ...
                        new Function1<PLVChatMessagePopupMenu, Unit>() {
                            ...
                            public Unit invoke(PLVChatMessagePopupMenu chatMessagePopupMenu) {
                                chatMessagePopupMenu.hide();
                                PLVLSConfirmDialog.Builder.context(chatMessagePopupMenu.getAnchor().getContext())
