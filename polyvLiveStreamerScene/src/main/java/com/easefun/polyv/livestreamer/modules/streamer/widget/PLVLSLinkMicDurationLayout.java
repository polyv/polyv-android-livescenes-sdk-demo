package com.easefun.polyv.livestreamer.modules.streamer.widget;
 ...
 * @author Hoshiiro
 */
public class PLVLSLinkMicDurationLayout extends FrameLayout {
    ...
    public PLVLSLinkMicDurationLayout(@NonNull Context context) {
        super(context);
        init();
    }

    public PLVLSLinkMicDurationLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PLVLSLinkMicDurationLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.plvls_linkmic_duration_layout, this);

        linkmicDurationTv = findViewById(R.id.plvls_linkmic_duration_tv);
