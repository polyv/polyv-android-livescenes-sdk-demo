package com.plv.livehiclass.modules.chatroom;
...
import com.plv.livecommon.ui.widget.PLVOutsideTouchableLayout;
import com.plv.livecommon.ui.widget.PLVSimpleSwipeRefreshLayout;
import com.plv.livecommon.ui.widget.imageScan.PLVChatImageViewerFragment;
import com.plv.livecommon.ui.widget.itemview.PLVBaseViewData;
import com.plv.livehiclass.R;
import com.plv.livehiclass.modules.chatroom.adapter.PLVHCMessageAdapter;
import com.plv.livehiclass.modules.chatroom.adapter.holder.PLVHCMessageViewHolder;
import com.plv.livehiclass.modules.chatroom.utils.PLVHCChatroomUtils;
import com.plv.livehiclass.modules.chatroom.widget.PLVHCChatMsgInputWindow;
...
public class PLVHCChatroomLayout extends FrameLayout implements IPLVHCChatroomLayout, View.OnClickListener {
        ...
        chatMessageAdapter.setOnViewActionListener(new PLVHCMessageAdapter.OnViewActionListener() {
            ...
            public void onShowAnswerWindow(final PLVChatQuoteVO chatQuoteVO, final String quoteId) {
                ...
                PLVHCChatMsgInputWindow.show(((Activity) getContext()), intent, new PLVHCChatMsgInputWindow.MessageSendListener() {
                    @Override
                    public void onSendImg(PLVSendLocalImgEvent imgEvent) {
    ...
    private void sendChatMessage(PLVSendLocalImgEvent imgEvent) {
