package com.plv.livehiclass.modules.document.popuplist.vo;
...
public class PLVHCPptVO implements Cloneable {
    ...
    public PLVHCPptVO(String image, Integer id) {
        this.image = image;
        this.id = id;
    }

    public PLVHCPptVO(String image, String name, String suffix, Integer id) {
        this.image = image;
        this.name = name;
        this.suffix = suffix;
        this.id = id;
    ...
    @Override
    public PLVHCPptVO clone() {
        try {
            return (PLVHCPptVO) super.clone();
        } catch (CloneNotSupportedException e) {
            PLVHCPptVO pptVO = new PLVHCPptVO(image, name, suffix, id);
