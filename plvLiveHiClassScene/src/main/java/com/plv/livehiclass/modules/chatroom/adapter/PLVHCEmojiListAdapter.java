 ...
 * 表情列表适配器
 */
public class PLVHCEmojiListAdapter extends RecyclerView.Adapter<PLVHCEmojiListAdapter.EmojiItemViewHolder> {
    // <editor-fold defaultstate="collapsed" desc="变量">
    private List<String> emoLists;
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="构造器">
    public PLVHCEmojiListAdapter() {
    ...
    public EmojiItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new EmojiItemViewHolder
                (LayoutInflater.from(parent.getContext()).inflate(R.layout.plvhc_chatroom_emoji_small_item, parent, false));
    }
