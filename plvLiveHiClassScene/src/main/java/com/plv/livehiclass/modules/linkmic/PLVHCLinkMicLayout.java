package com.plv.livehiclass.modules.linkmic;
...
import com.plv.livecommon.module.modules.multirolelinkmic.presenter.PLVMultiRoleLinkMicPresenter;
import com.plv.livecommon.module.modules.multirolelinkmic.view.PLVAbsMultiRoleLinkMicView;
import com.plv.livecommon.module.utils.PLVForegroundService;
import com.plv.livecommon.ui.widget.PLVConfirmDialog;
import com.plv.livehiclass.R;
import com.plv.livehiclass.modules.linkmic.list.IPLVHCLinkMicItemLayout;
import com.plv.livehiclass.modules.linkmic.list.item.IPLVHCLinkMicItem;
import com.plv.livehiclass.modules.linkmic.list.item.PLVHCLinkMicItemContainer;
import com.plv.livehiclass.modules.linkmic.widget.PLVHCJoinDiscussCountDownWindow;
import com.plv.livehiclass.modules.linkmic.widget.PLVHCLinkMicInvitationCountdownWindow;
import com.plv.livehiclass.modules.linkmic.widget.PLVHCReceiveBroadcastDialog;
import com.plv.livehiclass.modules.linkmic.widget.PLVHCSeminarCountdownWindow;
import com.plv.livehiclass.modules.linkmic.widget.PLVHCTeacherScreenStreamLayout;
import com.plv.livehiclass.modules.linkmic.zoom.PLVHCLinkMicZoomManager;
import com.plv.livehiclass.modules.liveroom.PLVHCClassStopHasNextDialog;
import com.plv.livehiclass.modules.liveroom.PLVHCClassStopNoNextDialog;
import com.plv.livehiclass.modules.liveroom.PLVHCLinkMicUserControlDialog;
import com.plv.livehiclass.scenes.PLVHCLiveHiClassActivity;
...
public class PLVHCLinkMicLayout extends FrameLayout implements IPLVHCLinkMicLayout {
    ...
    private void initView() {
        ...
        //启动前台服务，防止在后台被杀
        PLVForegroundService.startForegroundService(PLVHCLiveHiClassActivity.class, "互动学堂", R.drawable.plvhc_ic_launcher);
    }
