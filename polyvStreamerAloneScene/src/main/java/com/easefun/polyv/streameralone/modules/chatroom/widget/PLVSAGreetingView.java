...
public class PLVSAGreetingView extends FrameLayout {
    ...
    public PLVSAGreetingView(@NonNull Context context) {
        this(context, null);
    }

    public PLVSAGreetingView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PLVSAGreetingView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        View.inflate(getContext(), R.layout.plvsa_chatroom_greeting_layout, this);
