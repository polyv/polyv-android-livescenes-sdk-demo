 ...
 * @author Hoshiiro
 */
public class PLVSALinkMicInvitationLayout extends FrameLayout {
    ...
    public PLVSALinkMicInvitationLayout(@NonNull Context context) {
        super(context);
        init();
    }
    ...
    public void setIsOnlyAudio(boolean isOnlyAudio) {
        ...
        for (View view : portLayout.cameraControlViews()) {
        ...
        portLayout.titleTextView().setText(text);
    ...
    public PLVSALinkMicInvitationLayout setOnViewActionListener(OnViewActionListener onViewActionListener) {
        ...
        updateTimeLeftDisposable = PLVTimer.timer(
                ...
                new Consumer<Long>() {
                    ...
                    public void accept(Long aLong) throws Exception {
                        ...
                        String text = PLVAppUtils.formatString(R.string.plv_linkmic_not_yet, timeLeftInSecond + "");
                        portLayout.cancelInvitationTextView().setText(text);
                        landLayout.cancelInvitationTextView().setText(text);
                    }
                });
    }
    ...
    private ChildLayout getChildLayout() {
        return PLVScreenUtils.isPortrait(getContext()) ? portLayout : landLayout;
    }
    ...
    private static class PortLayout extends FrameLayout implements ChildLayout {
        ...
        public PortLayout(@NonNull Context context) {
            super(context);
            LayoutInflater.from(getContext()).inflate(R.layout.plvsa_linkmic_invitation_port_layout, this);
            findView();
        }

        private void findView() {
            linkmicInvitationTitleTv = findViewById(R.id.plvsa_linkmic_invitation_title_tv);
            linkmicInvitationCameraLayout = findViewById(R.id.plvsa_linkmic_invitation_camera_layout);
            linkmicInvitationCameraPreviewView = findViewById(R.id.plvsa_linkmic_invitation_camera_preview_view);
            linkmicInvitationCameraClosedHintLayout = findViewById(R.id.plvsa_linkmic_invitation_camera_closed_hint_layout);
            linkmicInvitationOnlyAudioHintLayout = findViewById(R.id.plvsa_linkmic_invitation_only_audio_hint_layout);
            linkmicInvitationCameraIv = findViewById(R.id.plvsa_linkmic_invitation_camera_iv);
            linkmicInvitationCameraTv = findViewById(R.id.plvsa_linkmic_invitation_camera_tv);
            linkmicInvitationCameraSwitch = findViewById(R.id.plvsa_linkmic_invitation_camera_switch);
            linkmicInvitationMicrophoneIv = findViewById(R.id.plvsa_linkmic_invitation_microphone_iv);
            linkmicInvitationMicrophoneTv = findViewById(R.id.plvsa_linkmic_invitation_microphone_tv);
            linkmicInvitationMicrophoneSwitch = findViewById(R.id.plvsa_linkmic_invitation_microphone_switch);
            linkmicInvitationPrivacyNotifyIv = findViewById(R.id.plvsa_linkmic_invitation_privacy_notify_iv);
            linkmicInvitationPrivacyNotifyTv = findViewById(R.id.plvsa_linkmic_invitation_privacy_notify_tv);
            linkmicInvitationCancelTv = findViewById(R.id.plvsa_linkmic_invitation_cancel_tv);
            linkmicInvitationAcceptTv = findViewById(R.id.plvsa_linkmic_invitation_accept_tv);
        }
    ...
    private static class LandLayout extends FrameLayout implements ChildLayout {
        ...
        public LandLayout(@NonNull Context context) {
            super(context);
            LayoutInflater.from(getContext()).inflate(R.layout.plvsa_linkmic_invitation_land_layout, this);
            findView();
        }
