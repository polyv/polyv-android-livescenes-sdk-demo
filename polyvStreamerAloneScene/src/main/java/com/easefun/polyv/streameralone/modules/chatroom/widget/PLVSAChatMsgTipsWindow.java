 ...
 * 聊天信息提示窗口
 */
public class PLVSAChatMsgTipsWindow {
    ...
    public PLVSAChatMsgTipsWindow(View anchor) {
        View contentView = View.inflate(anchor.getContext(), R.layout.plvsa_chatroom_msg_tips_layout, null);
        ...
        orientedView = contentView.findViewById(R.id.plvsa_oriented_view);
        tipsMsgTv = contentView.findViewById(R.id.plvsa_chatroom_tips_msg_tv);
    }
    // </editor-fold>
