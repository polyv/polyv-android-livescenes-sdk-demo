...
public class PLVSAVerticalBeautyLayout extends FrameLayout implements IPLVSABeautyLayout {
    ...
    public PLVSAVerticalBeautyLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PLVSAVerticalBeautyLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.plvsa_live_room_beauty_vertical_layout, this, true);
    ...
    private void initRecyclerView() {
        beautyOptionAdapter.setOnSelectedListener(new PLVSABeautyOptionAdapter.OnSelectedListener() {
            ...
            public void onSelected(@Nullable IPLVBeautyOption beautyOption) {
                ...
                PLVSAVerticalBeautyLayout.this.currentBeautyOption = beautyOption;
    ...
    private void observeUiState() {
        viewModel.getUiState().observe((LifecycleOwner) getContext(), new Observer<PLVBeautyUiState>() {
            ...
            public void onChanged(@Nullable PLVBeautyUiState uiState) {
                ...
                PLVSAVerticalBeautyLayout.this.uiState = uiState;
