...
public class PLVLCSignInTipsView extends FrameLayout {
    private static final String TAG = "PLVLCSignInTipsView";
    ...
    public PLVLCSignInTipsView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PLVLCSignInTipsView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        View.inflate(getContext(), R.layout.plvlc_chatroom_sign_in_tips_layout, this);
