 ...
 * @author Hoshiiro
 */
public class PLVLCMemberListRuleDescriptionLayout extends FrameLayout {
    ...
    public PLVLCMemberListRuleDescriptionLayout(@NonNull Context context) {
        super(context);
        init();
    }

    public PLVLCMemberListRuleDescriptionLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PLVLCMemberListRuleDescriptionLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.plvlc_member_list_rule_description_layout, this);

        memberListRuleDescLayoutRoot = findViewById(R.id.plvlc_member_list_rule_desc_layout_root);
        memberListRuleDescBackIv = findViewById(R.id.plvlc_member_list_rule_desc_back_iv);
        memberListRuleDescTitleTv = findViewById(R.id.plvlc_member_list_rule_desc_title_tv);
